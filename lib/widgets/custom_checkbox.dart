...
class CustomCheckbox extends StatefulWidget {
  CustomCheckbox({
    ...
    this.activeColor,
    this.borderRadius = const Radius.circular(1.0),
    this.checkColor,
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.materialTapTargetSize ?? themeData.materialTapTargetSize) {
      ...
      case MaterialTapTargetSize.shrinkWrap:
        size = const Size(
            1.8 * kRadialReactionRadius, 1.8 * kRadialReactionRadius);
        break;
    }
...
class _RenderCheckbox extends RenderToggleable {
  ...
  RRect _outerRectAt(Offset origin, double t) {
    ...
    return RRect.fromRectAndRadius(rect, borderRadius);
  }

  // The checkbox's border color if value == false, or its fill color when
  // value == true or null.
  Color _colorAt(double t) {
    // As t goes from 0.0 to 0.25,
    // animate from the inactiveColor to activeColor.
